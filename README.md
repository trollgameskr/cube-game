...
2. 화면 하단의 버튼(U, D, L, R, F, B)을 클릭하여 각 면을 회전
3. 모든 면을 단색으로 맞추면 클리어!

### 버튼 설명
- **U/U'** (Up/위): 윗면 시계방향/반시계방향 회전 (노란색)
- **D/D'** (Down/아래): 아랫면 시계방향/반시계방향 회전 (마젠타색)
- **L/L'** (Left/왼쪽): 왼쪽면 시계방향/반시계방향 회전 (초록색)
- **R/R'** (Right/오른쪽): 오른쪽면 시계방향/반시계방향 회전 (파란색)
- **F/F'** (Front/앞): 앞면 시계방향/반시계방향 회전 (빨간색)
- **B/B'** (Back/뒤): 뒷면 시계방향/반시계방향 회전 (주황색)
